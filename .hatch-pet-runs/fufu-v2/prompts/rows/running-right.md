Create one horizontal animation strip for Codex pet `fufu`, state `running-right`.
...
Identity: same pet in every frame: Pixel-art Siamese kitten. Cream/tan body with dark brown points on ears, face mask, paws, and tail. Bright blue eyes with white highlights. Small pink nose. Friendly, compact, whole-body silhouette readable at 192x208. Flat pixel style, consistent palette, clean edges.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `pixel`: Pixel-art-adjacent digital mascot with a chunky silhouette, simple dark outline, limited palette, flat cel shading, and visible stepped edges. User style notes: Flat pixel-art style with clean readable silhouette; no gradients, no text, no props..
